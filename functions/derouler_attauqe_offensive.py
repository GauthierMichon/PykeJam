...
def Offensive(pokemon_attaquant, pokemon_defenseur, Attaque) :
    booleanAttaque = MissWork(pokemon_attaquant, Attaque)

    if booleanAttaque :
        print("that work")
        if Attaque.physique == 1 :
            AttaquePhy(pokemon_attaquant, pokemon_defenseur, Attaque)
        elif Attaque.special == 1 :
            AttaqueSpe(pokemon_attaquant, pokemon_defenseur, Attaque)
